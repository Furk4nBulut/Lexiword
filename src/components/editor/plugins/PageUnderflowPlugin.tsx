...
import { $getRoot, COMMAND_PRIORITY_LOW, KEY_BACKSPACE_COMMAND, type LexicalNode } from 'lexical';
  ...
  useEffect(() => {
    ...
    return editor.registerCommand(
      ...
      () => {
        editor.update(() => {
          ...
          for (let i = 0; i < pages.length - 1; i++) {
            ...
            if (blocks.length > 0 && nextBlocks.length > 0) {
              ...
              // Şimdilik: her backspace'te bir blok yukarı çek
        ...
        // Komutun işlenmesini engelleme, normal backspace devam etsin
        return false;
      },
